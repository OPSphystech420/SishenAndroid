...
#define HOOKSYM(lib, sym, ptr, org) hook(dlsym(dlopen(lib, RTLD_NOLOAD), sym), (void *)ptr, (void **)&org)
#define HOOKSYM_NO_ORIG(lib, sym, ptr) hook(dlsym(dlopen(lib, RTLD_NOLOAD), sym), (void *)ptr, NULL)
